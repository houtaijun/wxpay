...
class WxPayConfig
{
     ...
     */
    public static function setSslcertPath($sslcert_path)
    {
        self::$sslcertPath = $sslcert_path;
    }
     ...
     */
    public static function setSslkeyPath($sslkey_path)
    {
        self::$sslkeyPath = $sslkey_path;
    }
